    ...
    <Card className="w-full">
      <CardContent className="pt-6">
        ...
        <div className="create-event-input-container | mt-10 flex items-center justify-center gap-[32px] md:flex-col max-sm:flex-col lg:flex-row">
          <label htmlFor="inputField" className="w-[328px] h-[155px] border-[1px] border-dotted border-buttonColor rounded-[8px] flex items-center justify-center cursor-pointer">
