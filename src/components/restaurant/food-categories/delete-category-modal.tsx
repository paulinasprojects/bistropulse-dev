  ...
  return (
    <div className="delete-category-modal">
      <div className="flex items-center justify-between mx-5">
        <span className='text-xl font-semibold text-textBlackColor'>Delete Category</span>
      ...
      <div className="mt-6 flex flex-col items-center gap-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className='w-[160px] h-[48px] bg-buttonColor hover:bg-buttonHover text-white rounded-[6px] font-semibold' onClick={setOpenModal}>Yes, Delete</button>
        </div>
      </div>
    </div>
  )
